...
<div class="flex-1 h-fit w-screen overflow-hidden text-neutral bg-red">
	<header class="container mx-auto top-0 border-b z-20 transition-all py-5 border-transparent">
		<div class=" mx-auto px-5">
			...
			>
				<div class="flex w-full lg:w-auto items-center justify-between">
					<a
						href="/"
						class="font-bold text-lg flex items-center transition focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary/50 focus-visible:outline-none focus-visible:shadow-outline-primary rounded-full px-2 -ml-2"
					>
						<span class=" text-primary">V</span>
						<span class="text-neutral/50 font-semibold">E</span>
						<span class=" text-primary">R</span>
						<span class=" text-primary">B</span>
						<span class="text-neutral/50 font-semibold">A</span>
						<span class=" text-primary">T</span>
						<span class="text-neutral/50 font-semibold">I</span>
						<span class=" text-primary">M</span>

						<!-- <span
							class="uppercase mt-0.5 leading-none text-[10px] ml-1 font-bold bg-base-300 text-neutral/70 px-2 py-1 rounded-md"
							>PRO</span
						> -->
					</a>
				</div>
				<nav class="astronav-items astronav-toggle hidden w-full lg:w-auto mt-2 lg:flex lg:mt-0">
					<ul class="flex flex-col lg:flex-row lg:gap-3">
						<li>
							<a
								href="/pricing"
								class="flex lg:px-3 py-2 text-sm text-neutral/70 hover:text-primary focus-visible:ring-2 focus-visible:ring-offset-2 transition focus-visible:ring-primary/50 focus-visible:outline-none focus-visible:shadow-outline-primary rounded-full"
							>
								Pricing
							</a>
						</li>
	...
	<div class="overflow-x-clip container mx-auto">
		<div class="mx-auto px-5">
			<main class="grid lg:grid-cols-5 place-items-center relative">
				<div
					class="absolute w-96 h-96 blur-2xl -z-10 bg-gradient-radial from-primary/200 right-0 top-0"
				></div>
				<div
				...
				<div class="max-w-sm md:max-w-max lg:col-span-2">
					...
					>
						Master Your Studies with VRBTM
					</h1>
					<p
						class="text-lg mt-4 max-w-lg text-neutral/60 [text-wrap:balance] text-center lg:text-start"
					>
						Boost your learning efficiency with VRBTM. Our app uses AI to help you memorize your
						subjects by omitting words, generating flashcards, and creating personalized notebooks.
					</p>
				...
				<div class="py-3 lg:col-span-3 lg:-mr-44">
					<picture>
						...
						/>
						<img
							src="/_astro/hero-screenshot.HaV5_ts2_10u77m.png"
							...
							alt="Visualization of vrbtm in action"
							sizes="(max-width: 1024px) 100vw, 50vw"
							loading="eager"
							fetchpriority="high"
							width="1183"
	...
	<div class=" container mx-auto px-5">
		<div>
			<h2 class="text-center text-neutral/60">Trusted by popular startups you know</h2>
			<div
				class="flex gap-x-8 gap-y-4 md:gap-20 lg:gap-28 items-center justify-center mt-6 flex-wrap"
			>
				<div class="text-neutral/70 my-2 h-7 md:h-9">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						...
						width="97"
						class="h-full w-auto"
						><clipPath id="a"><path d="m0 0h97v48h-97z"></path></clipPath><g
							clip-path="url(#a)"
							fill="current"
							><path
								clip-rule="evenodd"
		...
		<div class="max-w-4xl mx-auto flex flex-col items-center justify-center mt-24">
			<span
				class="bg-accent/10 border-accent/20 border text-accent rounded-full text-xs font-medium px-3 py-1"
			>
				FEATURE HIGHLIGHTS
			</span>
			<h2 class="text-4xl lg:text-5xl text-neutral/90 font-bold lg:tracking-tight mt-4 text-center">
				Enhance Your Study Efficiency
			</h2>
			<p class="text-lg mt-4 text-neutral/60 text-center [text-wrap:pretty]">
				Master your subjects with vrbtm’s AI-powered tools. From smart word omission to flashcard
				creation, vrbtm provides an all-in-one solution to make your study sessions more effective
				and engaging.
			</p>
		</div>
		<div class="grid md:grid-cols-2 py-10">
			<div class="grid place-items-center">
				<picture>
					...
					<source srcset="/_astro/6.Ep0jo6kx_Z1QgT1P.webp" type="image/webp" />
					<img
			...
			<div class="grid place-items-center">
				<div class="max-w-lg">
					<span
						class="bg-accent/10 border-accent/20 border text-accent -ml-px rounded-full text-xs font-medium px-3 py-1"
					>
						Smart Study Tools
					</span>
					<h3 class="text-2xl text-neutral/80 font-semibold mt-4 [text-wrap:balance]">
						Transform Your Learning with AI-Powered Memorization Techniques
					</h3>
					<p class="mt-4 text-neutral/60 [text-wrap:balance]">
						vrbtm’s advanced AI helps you memorize effortlessly by intelligently omitting words and
						generating flashcards, making your study sessions more interactive and effective.
					</p>
						...
						<li class="flex items-center gap-3 text-neutral-800">
							...
							>
								<symbol id="ai:ph:check-circle-fill"
									...
									></path></symbol
								> <use xlink:href="#ai:ph:check-circle-fill"></use>
							</svg>
							<span class="text-sm">AI-Powered Word Omission</span>
						</li>
						<li class="flex items-center gap-3 text-neutral-800">
							<svg
								width="1em"
							...
							<span class="text-sm">Custom Flashcard Generation</span>
						</li>
						<li class="flex items-center gap-3 text-neutral-800">
							<svg
								width="1em"
							...
							<span class="text-sm">Interactive Notebooks</span>
						</li>
					</ul>
		...
		<div class="grid md:grid-cols-2 py-10">
			...
			<div class="grid place-items-center">
				<div class="max-w-lg">
					...
					<h3 class="text-2xl text-neutral/80 font-semibold mt-4 [text-wrap:balance]">
						Tailor Your Study Sessions with AI-Powered Insights
					</h3>
					<p class="mt-4 text-neutral/60 [text-wrap:balance]">
						Let vrbtm’s AI analyze your study habits to provide customized learning paths, ensuring
						you focus on the areas that matter most.
					</p>
					<ul class="grid mt-6 text-left gap-y-4">
						<li class="flex items-center gap-3 text-neutral-800">
							<svg
							...
							<span class="text-sm">Adaptive Learning Paths</span>
						</li>
						<li class="flex items-center gap-3 text-neutral-800">
							<svg
								width="1em"
						...
						<li class="flex items-center gap-3 text-neutral-800">
							...
							<span class="text-sm">Real-Time Feedback</span>
						</li>
					</ul>
					<div class="flex items-center gap-4 mt-6">
						<a
	...
	<div class="mt-10 relative overflow-x-clip">
		<div
			class="absolute w-96 h-96 blur-2xl -z-10 bg-gradient-radial from-primary/100 right-1/3 -top-10"
		></div>
		<div
		...
		<div class="relative md:flex gap-10 overflow-hidden py-5 group">
			...
			>
				<div
					class=" rounded-2xl relative p-8 bg-base-200/50/60 backdrop-blur-md transition-all ring-1 ring-base-300/50 shadow hover:shadow-lg w-[calc(100vw-5.75rem)] max-w-md flex flex-col justify-between snap-start snap-always shrink-0 first-of-type:scroll-m-10 scroll-m-5"
				>
					<blockquote class="text-lg md:text-xl [text-wrap:balance]">
						Astroship has transformed the way we manage our projects. Its well-designed interface
						and powerful features make it a must-have tool for any startup. We've seen a great
						increase in our productivity and collaboration.
					</blockquote>
					<div class="flex items-center gap-3 mt-10">
						...
						<div>
							<h2 class="font-medium text-neutral/80">John Doe</h2>
							<p class="text-sm text-neutral/60">CEO at TechCorp</p>
						</div>
					</div>
				</div>
				<div
				...
				>
					<blockquote class="text-lg md:text-xl [text-wrap:balance]">
						As a marketing professional, I love using Astroship to streamline our marketing
					...
					<div class="flex items-center gap-3 mt-10">
						...
						<div>
							<h2 class="font-medium text-neutral/80">Jane Smith</h2>
							<p class="text-sm text-neutral/60">Marketing Manager at InnovateTech</p>
						</div>
					</div>
				</div>
				<div
				...
				>
					<blockquote class="text-lg md:text-xl [text-wrap:balance]">
						Astroship has revolutionized the way we handle customer support. The ticketing system
						and knowledge base have significantly reduced response times, leading to happier
						customers. Thanks to this incredible tool.
					</blockquote>
					<div class="flex items-center gap-3 mt-10">
						<div class="shrink-0">
							<div class="h-12 w-12 bg-base-300 rounded-full"></div>
						...
						<div>
							<h2 class="font-medium text-neutral/80">Mike Johnson</h2>
							<p class="text-sm text-neutral/60">CTO at CloudNine</p>
						</div>
					</div>
				</div>
				<div
				...
				>
					<blockquote class="text-lg md:text-xl [text-wrap:balance]">
						Astroship has simplified our employee management processes. From onboarding to
						performance evaluations, everything is now seamlessly organized in one place. It's made
						my job much more manageable and enjoyable!
					</blockquote>
					<div class="flex items-center gap-3 mt-10">
						<div class="shrink-0">
							<div class="h-12 w-12 bg-base-300 rounded-full"></div>
						...
						<div>
							<h2 class="font-medium text-neutral/80">Emily Brown</h2>
							<p class="text-sm text-neutral/60">HR Manager at ConnectCo</p>
						</div>
					</div>
				</div>
				<div
				...
				>
					<blockquote class="text-lg md:text-xl [text-wrap:balance]">
						Our sales team swears by Astroship's CRM capabilities. The lead tracking and pipeline
						management tools have resulted in a significant boost in sales. It's a versatile
						platform that has truly optimized our sales processes.
					</blockquote>
					<div class="flex items-center gap-3 mt-10">
						<div class="shrink-0">
							<div class="h-12 w-12 bg-base-300 rounded-full"></div>
						...
						<div>
							<h2 class="font-medium text-neutral/80">David Lee</h2>
							<p class="text-sm text-neutral/60">Sales Director at Linkify</p>
						</div>
					</div>
				</div>
				<div
				...
				>
					<blockquote class="text-lg md:text-xl [text-wrap:balance]">
						Astroship has been a lifesaver for our finance department. Its robust accounting
						features and automated invoicing have saved us countless hours of manual work. It's the
						perfect financial companion for any business!
					</blockquote>
					<div class="flex items-center gap-3 mt-10">
						<div class="shrink-0">
							<div class="h-12 w-12 bg-base-300 rounded-full"></div>
						...
						<div>
							<h2 class="font-medium text-neutral/80">Sarah Martinez</h2>
							<p class="text-sm text-neutral/60">Finance Controller at MoneyMakers</p>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container mx-auto px-5">
		<div class="mt-24 text-neutral">
			<h2 class="text-4xl lg:text-5xl font-bold lg:tracking-tight">
				Everything you need to <span class="text-primary">master your studies</span>
			</h2>
			<p class="text-lg mt-4 text-neutral/60">
				VRBTM is your AI-powered study companion that helps you memorize and retain information
				efficiently. It brings together advanced techniques to support your learning journey.
			</p>
		</div>
		<div class="grid md:grid-cols-2 lg:grid-cols-5 mt-16 gap-10">
			<div
				class="rounded-2xl p-8 bg-base-200/50 transition-all ring-1 ring-base-300/50 shadow hover:shadow-lg lg:col-span-3"
			>
				<div class="overflow-hidden flex items-start justify-center h-auto relative lg:h-80">
					<div
						class="absolute inset-0 bg-gradient-to-t from-base-200/50 via-transparent z-10"
					></div>
					<picture>
						<source srcset="/_astro/2.ldT67BXv_ZIfUrc.avif" type="image/avif" /><source
				...
				<div class="mt-2">
					...
					<h3 class="text-xl lg:text-2xl text-neutral font-medium mt-2">
						<span>Smart Memorization</span>
					</h3>
					<p class="text-neutral/60 mt-2 [text-wrap:balance]">
						<span>
							VRBTM intelligently omits words from your study material, challenging your recall and
							helping you master your subjects more effectively.
						</span>
					</p>
				</div>
			</div>
			<div
				class="rounded-2xl p-8 bg-base-200/50 transition-all ring-1 ring-base-300/50 shadow hover:shadow-lg lg:col-span-2"
			>
				<div class="overflow-hidden flex items-start justify-center h-auto relative lg:h-80">
					<div
						class="absolute inset-0 bg-gradient-to-t from-base-200/50 via-transparent z-10"
				...
				<div class="mt-2">
					<span
						class="bg-primary/10 border-primary/20 border text-primary rounded-full text-xs font-medium px-3 py-1"
					>
					...
					<p class="text-neutral/60 mt-2 [text-wrap:balance]">
						<span>
							VRBTM allows you to quickly create personalized flashcards for focused study sessions,
		...
		<div class="grid md:grid-cols-2 lg:grid-cols-3 mt-10 gap-10">
			<div
				class="rounded-2xl p-8 bg-base-200/50 transition-all ring-1 ring-base-300/50 shadow hover:shadow-lg"
			>
				<div class="overflow-hidden flex items-start justify-center h-auto relative lg:h-60">
					...
					></div>
					<picture>
						<source srcset="/_astro/3.XiLsQFjx_Z1JuNDf.avif" type="image/avif" /><source
				...
				<div class="mt-2">
					...
					<p class="text-neutral/60 mt-2 [text-wrap:balance]">
						<span>
							With VRBTM, create digital notebooks to store, organize, and review all your learning
							material in one place.</span
						>
					</p>
				</div>
			</div>
			...
			>
				...
				<div class="mt-2">
					...
					<p class="text-neutral/60 mt-2 [text-wrap:balance]">
						<span>
							VRBTM makes your study sessions more effective by challenging your memory in a dynamic
							way, leading to improved retention and understanding.</span
						>
					</p>
				</div>
			</div>
			...
			>
				...
				<div class="mt-2">
					<span
						class="bg-base-200 border-base-300 border text-neutral/80 rounded-full text-xs font-medium px-3 py-1"
					>
						<span>AI-Powered Learning</span>
					</span>
					<h3 class="text-xl lg:text-2xl text-neutral font-medium mt-2">
						<span>Memorize Effectively</span>
					</h3>
					<p class="text-neutral/60 mt-2 [text-wrap:balance]">
						<span
							>VRBTM helps students memorize their subjects by omitting words in the text using AI,
							making learning faster and more efficient.</span
						>
					</p>
				</div>
			</div>
		...
		<div class="mt-24 max-w-3xl mx-auto flex flex-col items-center justify-center">
			...
			<h2 class="text-neutral text-4xl lg:text-5xl font-bold lg:tracking-tight mt-4 text-center">
				Unlock Your Learning Potential
			</h2>
			<p class="text-lg mt-4 text-neutral/60 text-center [text-wrap:pretty]">
				VRBTM offers innovative tools to enhance your study experience. With features like word
				omission and flashcard generation, we're here to help you excel. If you have any questions
				or need assistance, feel free to reach out!
			</p>
		</div>

		<div class="text-neutral grid sm:grid-cols-2 md:grid-cols-3 mt-16 gap-8 md:gap-16">
			<div
				class="flex flex-col gap-4 items-start group hover:bg-base-200/50 hover:border-base-200 border border-transparent rounded-lg transition-all md:-m-5 p-5"
			>
				<div
					class="mt-1 bg-primary/10 border shadow shadow-primary/10 border-primary/30 transition-colors rounded-lg grid place-items-center p-2 w-10 h-10 shrink-0"
				>
					<svg
						width="24"
						height="24"
					...
					>
						<symbol id="ai:fluent:document-javascript-24-regular"
							...
							></path></symbol
						> <use xlink:href="#ai:fluent:document-javascript-24-regular"></use>
					</svg>
				</div>
				<div>
					<h3 class="font-semibold text-lg">Master Your Studies with VRBTM</h3>
					<p class="text-neutral/60 mt-2 leading-relaxed">
						Enhance your learning experience by using AI to create customized study materials. Omit
						key words, generate flashcards, and create notebooks to help you memorize subjects
						effectively.
					</p>
				</div>
			</div>
				...
				>
					...
					>
						<symbol id="ai:fluent:trophy-24-regular"
							...
							></path></symbol
						> <use xlink:href="#ai:fluent:trophy-24-regular"></use>
					</svg>
				</div>
				<div>
					<h3 class="font-semibold text-lg">Achieve Your Academic Goals with VRBTM</h3>
					<p class="text-neutral/60 mt-2 leading-relaxed">
						Leverage AI to enhance your study routine! Our app helps you memorize subjects by
						omitting key words, while also allowing you to create flashcards and personalized
						notebooks for effective learning.
					</p>
				</div>
			</div>
				...
				>
					...
					>
						<symbol id="ai:fluent:box-24-regular"
							...
							></path></symbol
						> <use xlink:href="#ai:fluent:box-24-regular"></use>
					</svg>
				</div>
				<div>
					<h3 class="font-semibold text-lg">Flexible Study Tools</h3>
					<p class="text-neutral/60 mt-2 leading-relaxed">
						Customize your learning experience with VRBTM! Our app provides on-demand flashcards and
						notebooks to help you focus on what you need to memorize, all powered by advanced AI.
					</p>
				</div>
			</div>
			...
			>
				...
				>
					...
					>
						...
						<use xlink:href="#ai:fluent:box-multiple-24-regular"></use>
					</svg>
				</div>
				<div>
					<h3 class="font-semibold text-lg">Smart Learning</h3>
					<p class="text-neutral/60 mt-2 leading-relaxed">
						VRBTM leverages AI to enhance your study sessions by omitting key words from your notes,
						making it easier to memorize important concepts. Generate flashcards and create custom
						notebooks for a personalized learning experience.
					</p>
				</div>
			</div>
				...
				>
					...
					>
						<symbol id="ai:fluent:book-search-24-regular"
							...
							></path></symbol
						> <use xlink:href="#ai:fluent:book-search-24-regular"></use>
					</svg>
				</div>
				<div>
					<h3 class="font-semibold text-lg">AI-Powered Memorization</h3>
					<p class="text-neutral/60 mt-2 leading-relaxed">
						VRBTM utilizes AI to help students memorize their subjects by intelligently omitting
						words from text. Create flashcards and notebooks effortlessly to enhance your learning
						experience!
					</p>
				</div>
			</div>
			...
			>
				...
				>
					...
					>
						...
						<use xlink:href="#ai:fluent:people-community-24-regular"></use>
					</svg>
				</div>
				<div>
					<h3 class="font-semibold text-lg">Memorization Made Easy</h3>
					<p class="text-neutral/60 mt-2 leading-relaxed">
						VRBTM leverages AI to help students enhance their memorization skills by intelligently
						omitting key words in provided texts. It also offers features to generate flashcards and
						create personalized notebooks for effective study.
					</p>
				</div>
			</div>
		</div>
	...
	<div class="bg-gradient-to-bl from-primary to-primary/85 p-8 md:px-20 md:py-20 mt-20">
		<div class="container mx-auto flex flex-col items-center text-center">
			<h2 class="text-white text-4xl md:text-6xl tracking-tight">
				Master Your Studies Effortlessly.
			</h2>
			<p class="text-white/80 mt-4 text-lg md:text-xl">
				Unlock the power of AI to help you memorize subjects by omitting key words, and easily
				create flashcards and notebooks to enhance your learning experience.
			</p>
			<div class="flex mt-5">
				<a
					href={null}
	...
	<footer class="py-14 bg-base-200 border-t border-base-200">
		<div class="container mx-auto px-5">
			<div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
				<div class="sm:col-span-2 md:col-span-3 lg:col-span-2">
					<a href="/" class="text-lg flex items-center">
						<span class="font-bold text-primary">VRBTM</span>
						<span class="text-neutral/60">app</span>
						<span
							class="uppercase mt-0.5 leading-none text-[10px] ml-1 font-bold bg-base-300 text-neutral/70 px-2 py-1 rounded-md"
							>EDU</span
						>
					</a>
					<p class="mt-4 text-sm text-neutral/70 max-w-xs">
						VRBTM is a powerful learning app designed to help students memorize their subjects
						effectively. Using AI, it omits specific words in the provided text, enhancing retention
						and comprehension. The app also allows users to generate flashcards and create
						personalized notebooks for their studies.
					</p>
					...
					<div class="flex gap-3 mt-4 items-center">
						<a
							...
							class="bg-base-300/60 hover:bg-base-300 rounded w-6 h-6 inline-flex items-center justify-center text-neutral/60"
						>
							<svg
								width="1em"
								height="1em"
							...
							</svg> <span class="sr-only">Twitter or X</span></a
						>
						<a
							...
							>
								<symbol id="ai:bx:bxl-linkedin-square"
									><path
										...
										fill="currentColor"
									></path></symbol
								> <use xlink:href="#ai:bx:bxl-linkedin-square"></use>
				...
				<div>
					...
					<div class="flex flex-col mt-3">
						...
						>
							Careers
						</a><a href="/blog" class="py-2 text-sm text-neutral/60 hover:text-primary"> Blog </a><a
							href="/contact"
							class="py-2 text-sm text-neutral/60 hover:text-primary"
						>
							Contact
		...
		<div class="mt-14 pt-8 px-5 border-t border-base-300">
			<div class=" mx-auto px-5">
				<p class="text-center text-sm text-neutral/60 [text-wrap:balance]">
					Copyright © 2024 Vrbtm. All rights reserved.
				</p>
				<p class="text-center text-xs text-neutral/60 mt-2">
					<a href="/terms" class="hover:text-primary/80"> Terms</a> ・
					<a href="/privacy" class="hover:text-primary/80"> Privacy</a>
				</p>
			</div>
		</div>
	</footer>
